$(function() {
  ...
  var $window = $(window).on("resize", function() {
    var main_boxes_container_new_height = $(window).height() - $logo.height();
    $main_boxes_container.height(main_boxes_container_new_height);

    var main_box_new_height = $main_box.width();

    // $main_box.height(main_box_new_height);
  ...
  // var main_boxes_container_new_height = window_height - logo_height;
  // $main_boxes_container.height(main_boxes_container_new_height);
  // console.log(typeof(window_height - logo_height));
  // console.log($main_boxes_container);
  // console.log(main_boxes_container_new_height);
});
